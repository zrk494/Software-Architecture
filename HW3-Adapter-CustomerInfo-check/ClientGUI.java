...
public class ClientGUI extends JPanel {
	...
	private JTextField txtCustomerName, txtAddress, txtZip, txtCellPhone, txtSSN, txtEmailAddr;
	private JLabel lblCustomerName, lblAddress, lblZip, lblCellphone, lblSSN, lblEmailAddr;
	...
	class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getActionCommand().equals(VALIDATE)) {
				...
				System.out.println("SSN String=" + ssn);
